...
class LLMClient:
    ...
    def generate(self, prompt: str, context: str = None, check_tokens: bool = True, options: dict = None) -> dict:
        """
        ...
        response = self._generate_openai(prompt, options=options)
    ...
    def _generate_openai(self, prompt: str, options: dict = None) -> dict:
